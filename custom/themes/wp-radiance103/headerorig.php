...
echo('Welcome, ' . $current_user->user_firstname .'&nbsp'. $current_user->user_lastname );

?> <a href="<?php echo wp_logout_url( get_permalink() ); ?>"><img src="/images/logout-short.png" width="140" height="25"></a> <?php

} else {

   ?><a href="/amember/signup"><img src="/images/signupnow-short.png" width="140" height="25"></a><a href="/amember/login"><img src="/images/login-short.png" width="140" height="25"></a><?php
