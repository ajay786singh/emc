				...
				// Shortlink Menu
				{
					...
					onclick: function() {
						editor.windowManager.open( {
							...
							onsubmit: function( e ) {
								editor.insertContent( '[tnc-pdf-viewer-shortlink file="' + e.data.file + '" target="' + e.data.linktarget + '" language="' + e.data.v_language + '" class="' + e.data.linkclass + '" text="' + e.data.linktext + '" page="' + e.data.jumptopage + '" default_zoom="' + e.data.defaultzoom + '"]');
							}
						});
					}
				},
				...
				// Thumbnail Shortcode
				{
					...
					onclick: function() {
						editor.windowManager.open( {
							...
							onsubmit: function( e ) {
								editor.insertContent( '[tnc-pdf-viewer-image file="' + e.data.file + '" target="' + e.data.linktarget + '" download="' + e.data.download + '" print="' + e.data.print + '" fullscreen="' + e.data.fullscreen + '" share="' + e.data.share + '" zoom="' + e.data.zoom + '" open="' + e.data.open + '" pagenav="' + e.data.pagenav + '" logo="' + e.data.logo + '" find="' + e.data.find + '" language="' + e.data.v_language + '" class="' + e.data.linkclass + '" text="' + e.data.linktext + '" page="' + e.data.jumptopage + '" default_zoom="' + e.data.defaultzoom + '"]PLACE YOUR IMG TAG HERE[/tnc-pdf-viewer-image]');
							}
						});
					}
				},
