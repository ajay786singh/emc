            ...
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <div style="<?php display_pagenav(); ?>" class="splitToolbarButton">
                  ...
                  <div class="splitToolbarButtonSeparator"></div>
                  <button style="<?php display_pagenav(); ?>" class="toolbarButton pageDown" title="Next Page" id="next" tabindex="8" data-l10n-id="next">
                ...
                <span style="<?php display_pagenav(); ?>" id="numPages" class="toolbarLabel"></span>
                 <span class="social_icon_d" id="open_slink" style="<?php display_share(); ?>"><img src="../images/share.png" title="Share Now!"></span>
                  <div style="display:none" class="tnc_social_share" id="tnc-share">
                  <?php 
                    function pagelink() {
                     $pageURL = 'http';
              ...
              <div style="<?php display_logo(); ?>" class="logo_block"><h3 class="logo_text"><a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php logo_image(); ?>" class="tnc_logo_image" /></a></h3></div>
              ...
              <div style="<?php display_fullscreen(); ?>" class="outerCenter">
...
<h3>Send This File to a friend</h3>
