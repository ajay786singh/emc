					...
					<div class="metabox-holder">	
						<div class="meta-box">
							<div id="fab-promo" class="postbox">
								...
								<div class="inside">
									<div>
										<p><a href="http://thematosoup.com/"><img src="<?php echo plugins_url( 'images/thematosoup.jpg' , __DIR__ ); ?>" /></a></p>
...
function ts_fab_validate_fields( $input) {
	...
	foreach( $input as $key => $value ) {
		...
		if( isset( $input[$key] ) ) {
			...
			$output[$key] = wp_kses( stripslashes( $input[ $key ] ), $allowed_tags );
